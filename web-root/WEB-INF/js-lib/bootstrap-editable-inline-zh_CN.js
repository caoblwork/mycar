    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/         
        name: null,
        /**
        Primary key of editable object (e.g. record id in database). For composite keys use object, e.g. <code>{id: 1, lang: 'zh'}</code>.
 ...
 */				
			...
			this.picker.find('.datepicker-days thead th:eq(1)').text(year + "年" + dates[this.language].months[month]);
