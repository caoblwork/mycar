...
@Service("tollCostService")
public class TollCostServiceImpl implements TollCostService {

	@Resource private CostRepo costRepo;
	
	public void addTollCost(TollCost tollCost) {
		Validate.notNull(tollCost);
		costRepo.save(tollCost);
	}
