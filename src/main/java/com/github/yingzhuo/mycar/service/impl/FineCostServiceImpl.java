...
@Service("fineCostService")
public class FineCostServiceImpl implements FineCostService {

	@Resource private CostRepo costRepo;

	@Override
	public void addFineCost(FineCost fineCost) {
		Validate.notNull(fineCost);
		costRepo.save(fineCost);
	}
