...
import com.github.yingzhuo.mycar.form.GasCostForm;
import com.github.yingzhuo.mycar.service.GasCostService;

@Controller
@RequestMapping("/gas-cost")
public class GasCostController {
	...
	public @ResponseBody Object addGasCost(@Valid GasCostForm form, BindingResult bindingResult)
			throws IllegalAccessException, InvocationTargetException, NoSuchMethodException
	{
		...
		PropertyUtils.copyProperties(gasCost, form);
		gasCostService.addGasCost(gasCost);

		LOGGER.debug("{}", gasCost);
